...
/*Task 1: counterMaker()
  ...
  1. What is the difference between counter1 and counter2? counter 1 is global
  
  2. Which of the two uses a closure? How can you tell? 2 because the variable exists outside the function
  
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  counter 1 you can plug into anywhere whereas counter 2 only exists in the function
*/
